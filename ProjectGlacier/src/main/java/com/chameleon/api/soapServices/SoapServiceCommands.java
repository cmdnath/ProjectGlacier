...
public class SoapServiceCommands {
    private static final String ADD_CDATA = "fx:addcdata;";
    private static final String ADD_NODE = "fx:addnode;";
    private static final String ADD_NODES = "fx:addnodes;";
    private static final String ADD_ATTIRBUTE = "fx:addattribute;";
    private static final String ADD_NAMESPACE = "fx:addnamespace;";
    private static final String GET_DATE_TIME = "fx:getdatetime;";
    private static final String GET_DATE = "fx:getdate;";
    private static final String REMOVE_NODE = "fx:removenode";
    private static final String REMOVE_ATTRIBUTE = "fx:removeattribute";
    private static final String RANDOM_NUMBER = "fx:randomnumber;";
    private static final String RANDOM_STRING = "fx:randomstring;";
    private static final String RANDOM_ALPHANUMBERIC = "fx:randomalphanumeric;";

    public static String addCData(String cData) {
        return ADD_CDATA + cData;
    }
