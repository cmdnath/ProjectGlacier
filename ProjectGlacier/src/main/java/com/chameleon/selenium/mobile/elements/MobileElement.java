...
public class MobileElement extends Element {
    ...
    public MobileElement(final ExtendedMobileDriver driver, final By by) {
        super(driver, by);
    }

    public MobileElement(final ExtendedMobileDriver driver, final By by, final org.openqa.selenium.WebElement element) {
    ...
    public MobileElement findElement(By by) {
        ...
        MobileElement el = getWrappedElement().findElement(by);
    ...
    public List<MobileElement> findElements(By by) {
        ...
        List<MobileElement> elements = getWrappedElement().findElements(by);
    ...
    public void scrollIntoView() {
        ...
        DriverManager.getWebDriver().executeJavaScript("arguments[0].scrollIntoView(true);", extendedElement);
