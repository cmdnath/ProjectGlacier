...
public class DailyForecast {
	...
	*/
	...
	@Override
	public int hashCode() {
	return new HashCodeBuilder().append(realFeelTemperatureShade).append(realFeelTemperature).append(moon).append(epochDate).append(link).append(degreeDaySummary).append(date).append(sources).append(sun).append(temperature).append(mobileLink).append(additionalProperties).append(night).append(day).append(airAndPollen).append(hoursOfSun).toHashCode();
	}
