...
public class WetBulbTemperature {
     ...
     * @param metric
     */
    public WetBulbTemperature(Metric1 metric, Imperial1 imperial) {
        super();
        this.metric = metric;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WetBulbTemperature) == false) {
            return false;
        }
        WetBulbTemperature rhs = ((WetBulbTemperature) other);
