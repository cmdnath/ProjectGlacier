...
public class RealFeelTemperatureShade {
     ...
     * @param metric
     */
    public RealFeelTemperatureShade(Maximum maximum, Minimum minimum,Metric metric,Imperial imperial) {
        super();
    ...
    public void setImperial(Imperial imperial) {
	  ...
	  ToStringBuilder(this).append("maximum", maximum).append("minimum",
	  minimum).append("metric", metric).append("imperial", imperial).toString(); }
	  ...
	  true; } if ((other instanceof RealFeelTemperatureShade) == false) { return
	  false; } RealFeelTemperatureShade rhs = ((RealFeelTemperatureShade) other);
	  return new EqualsBuilder().append(maximum, rhs.maximum).append(minimum,
