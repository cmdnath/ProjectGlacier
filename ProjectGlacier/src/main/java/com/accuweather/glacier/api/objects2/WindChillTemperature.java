...
public class WindChillTemperature {
     ...
     * @param metric
     */
    public WindChillTemperature(Metric1 metric, Imperial1 imperial) {
        super();
        this.metric = metric;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WindChillTemperature) == false) {
            return false;
        }
        WindChillTemperature rhs = ((WindChillTemperature) other);
