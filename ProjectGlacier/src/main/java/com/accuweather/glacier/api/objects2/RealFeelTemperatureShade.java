...
public class RealFeelTemperatureShade {
	...
	* @param maximum
	*/
	public RealFeelTemperatureShade(Minimum minimum, Maximum maximum) {
	super();
	...
	if ((other instanceof RealFeelTemperatureShade) == false) {
	return false;
	}
	RealFeelTemperatureShade rhs = ((RealFeelTemperatureShade) other);
